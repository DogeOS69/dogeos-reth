...
impl ScrollReceiptEnvelope<Log> {
    ...
    pub fn from_parts<'a>(
        ...
        match tx_type {
            ScrollTxType::Legacy => Self::Legacy(ReceiptWithBloom {
                receipt: inner_receipt,
                logs_bloom,
            }),
            ScrollTxType::Eip2930 => Self::Eip2930(ReceiptWithBloom {
                receipt: inner_receipt,
                logs_bloom,
            }),
            ScrollTxType::Eip1559 => Self::Eip1559(ReceiptWithBloom {
                receipt: inner_receipt,
                logs_bloom,
            }),
            ScrollTxType::Eip7702 => Self::Eip7702(ReceiptWithBloom {
                receipt: inner_receipt,
                logs_bloom,
            }),
            ScrollTxType::L1Message => Self::L1Message(ReceiptWithBloom {
                receipt: inner_receipt,
                logs_bloom,
            }),
        }
