...
mod tests {
    ...
    #[test]
    fn payload_id_matches_the_legacy_scroll_v1_vector() {
        #[derive(serde::Deserialize)]
        #[serde(rename_all = "camelCase")]
        struct Fixture {
            parent_hash: B256,
            attributes: ScrollPayloadAttributes,
            expected_payload_id: PayloadId,
        }

        let fixture: Fixture = serde_json::from_str(include_str!(
            "../../../fixtures/engine-v1/payload-id-scroll-v1.json"
        ))
        .unwrap();

        assert_eq!(
            payload_id_scroll(&fixture.parent_hash, &fixture.attributes),
            fixture.expected_payload_id
        );
    }
