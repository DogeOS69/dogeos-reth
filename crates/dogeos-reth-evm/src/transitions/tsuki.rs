...
const TSUKI_NATIVE_DOGE_TOKEN_BYTECODE: Bytes = bytes!(
    ""
);
...
mod tests {
    ...
    fn test_native_doge_token_transfer_uses_tsuki_precompile() -> eyre::Result<()> {
        ...
        let result = evm.transact_commit(native_doge_token_tx(
            sender,
            0,
            transfer_calldata(recipient, transfer_amount),
        ))?;
        ...
        assert_eq!(
            evm.db_mut().basic(recipient)?.unwrap_or_default().balance,
            transfer_amount
        );
    ...
    fn test_native_doge_token_transfer_reverts_for_insufficient_balance() -> eyre::Result<()> {
        ...
        let result = evm.transact_commit(native_doge_token_tx(
            sender,
            0,
            transfer_calldata(recipient, initial_balance + U256::from(1)),
        ))?;
